...
def generate_launch_description():
    ...
    whill_config_path =  os.path.join(this_pkg_share_dir, "config", "whill_config.yaml") #path of the config file for share control
    with open(whill_config_path, 'r') as f:
    ...
    list = [
        ...
        Node(
            ...
            executable='velocity_by_joystick_control_node',
            name='velocity_by_joystick_control_node',
            output='screen',
            parameters=[
                whill_config_path
            ]
