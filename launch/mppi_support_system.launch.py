...
def generate_launch_description():
    ...
    share_control_config_path =  os.path.join(this_pkg_share_dir, "config", "mppi_shared_controller_config.yaml") #path of the config file for share control
